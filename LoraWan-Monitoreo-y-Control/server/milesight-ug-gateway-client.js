/**
 * Cliente para la API REST del gateway Milesight UG65/UG67 (puerto 8080): administración, datos, etc.
 * Los downlinks LoRaWAN de la aplicación van al **LNS integrado** (Semtech UDP), no a la cola REST del gateway.
